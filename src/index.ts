...
// Initialize theme from localStorage (shared by game and playground)
initTheme();

// Playground mode: #playground bypasses the game entirely
if (location.hash === "#playground") {
	const app = document.getElementById("app");
	if (app) {
		import("./components/RenderingPlayground").then(({ mountPlayground }) => {
			mountPlayground(app);
		});
	}
} else {
