/**
 * Mulberry32 seeded PRNG. Returns a stateful function that produces
 * sequential pseudo-random numbers in [0, 1).
 * Use for layout generation where many sequential draws are needed.
 */
